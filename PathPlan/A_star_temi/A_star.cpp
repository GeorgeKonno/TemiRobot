...
int main(){
    cv::Mat o_d_map = cv::imread("../pp_maps/cost_maps/2016-02-11_19\:07\:52_303_702_581_319.png",0);
    cv::Mat v_p_map = cv::imread("../pp_maps/attraction_maps/2016-02-11_19\:07\:52_303_702_581_319.png",0);
    cv::Mat f_c_map = cv::imread("../pp_maps/cone_maps/2016-02-11_19\:07\:52_303_702_581_319.png",0);
    cv::Mat o_map = cv::imread("../pp_maps/regular_maps/2016-02-11_19\:07\:52_303_702_581_319.png",0);
    IntPoint2D start_pixel;
    IntPoint2D goal_pixel;
    start_pixel.X = static_cast<int>(303); start_pixel.Y = static_cast<int>(702);
    goal_pixel.X = static_cast<int>(581); goal_pixel.Y = static_cast<int>(319);
